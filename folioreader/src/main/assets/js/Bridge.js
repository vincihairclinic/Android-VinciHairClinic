...
function computeLastReadCfi() {
    ...
    viewportRect = null;
    FolioPageFragment.storeLastReadCfi(cfi, test());
}
...
function showCalckView(el){
//    window.location = el+'://'
    FolioPageFragment.openShape(el);
}

document.addEventListener("DOMContentLoaded", function(event) {

   var el = document.querySelectorAll('[id^="chapter"]');
    el.forEach(x => {
        x.className += "section123";
    });

      var section = document.querySelectorAll(".section123");
      var sections = {};
      var i = 0;
...
//                		console.log('Element is fully visible in screen:  ' + i);
                         lastActiveElement = i;
                         computeLastReadCfi();
                	}
