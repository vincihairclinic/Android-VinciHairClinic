...
public class Config implements Parcelable {
    ...
    public static final String CONFIG_SHOW_TITLE = "show_title";
    public static final String CONFIG_SHOW_MENU = "show_menu";
    public static final String CONFIG_SHOW_CONFIG = "show_config";
    public static final String CONFIG_SHOW_SEARCH = "show_search";
    public static final String CONFIG_SHOW_BOOKMARK = "show_bookmark";
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (itemTitle ? 1 : 0));
        dest.writeByte((byte) (itemMenu ? 1 : 0));
        dest.writeByte((byte) (itemConfig ? 1 : 0));
        dest.writeByte((byte) (itemSearch ? 1 : 0));
        dest.writeByte((byte) (itemBookmark ? 1 : 0));
    }
    ...
    protected Config(Parcel in) {
        ...
        itemTitle = in.readByte() != 0;
        itemMenu = in.readByte() != 0;
        itemConfig = in.readByte() != 0;
        itemSearch = in.readByte() != 0;
        itemBookmark = in.readByte() != 0;
    }
    ...
    public Config(JSONObject jsonObject) {
        ...
        backgroundColor = jsonObject.optString(CONFIG_BACKGROUND_COLOR);

        itemTitle = jsonObject.optBoolean(CONFIG_SHOW_TITLE);
        itemMenu = jsonObject.optBoolean(CONFIG_SHOW_MENU);
        itemConfig = jsonObject.optBoolean(CONFIG_SHOW_CONFIG);
        itemSearch = jsonObject.optBoolean(CONFIG_SHOW_SEARCH);
        itemBookmark = jsonObject.optBoolean(CONFIG_SHOW_BOOKMARK);
    }
    ...
    public Config setItemTitle(boolean itemTitle) {
    ...
    public Config setItemMenu(boolean itemMenu) {
        this.itemMenu = itemMenu;
        return this;
    }

    public boolean isItemConfig() {
        return itemConfig;
    }

    public Config setItemConfig(boolean itemConfig) {
    ...
    public Config setItemSearch(boolean itemSearch) {
    ...
    public Config setItemBookmark(boolean itemBookmark) {
