...
public class FolioReader {
    ...
    public static final String EXTRA_CHAPTER_LINK = "com.folioreader.extra.CHAPTER_LINK";
    ...
    private Intent getIntentFromUrl(String assetOrSdcardPath, int rawId) {
        ...
        if (!chapterLink.isEmpty()) {
            intent.putExtra(EXTRA_CHAPTER_LINK, chapterLink);
        }
    ...
    public FolioReader setChapterLink(String href) {
        this.chapterLink = href;
        return singleton;
    }
