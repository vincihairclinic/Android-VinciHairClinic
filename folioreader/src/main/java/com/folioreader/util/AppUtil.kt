    ...
    companion object {
        ...
        fun saveConfig(context: Context?, config: Config) {
            ...
            try {
                ...
                obj.put(Config.CONFIG_BACKGROUND_COLOR, config.backgroundColor)

                obj.put(Config.CONFIG_SHOW_TITLE, config.isItemTitle)
                obj.put(Config.CONFIG_SHOW_MENU, config.isItemMenu)
                obj.put(Config.CONFIG_SHOW_CONFIG, config.isItemConfig)
                obj.put(Config.CONFIG_SHOW_SEARCH, config.isItemSearch)
                obj.put(Config.CONFIG_SHOW_BOOKMARK, config.isItemBookmark)
