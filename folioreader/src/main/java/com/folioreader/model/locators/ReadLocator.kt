...
open class ReadLocator : Locator, Parcelable {
    ...
    constructor(bookId: String, href: String, created: Long, locations: Locations, currentChapterId: String) :
            this(bookId, href, created, "", locations, null,currentChapterId)

    constructor(
        bookId: String, href: String, created: Long, title: String, locations: Locations,
        text: LocatorText?, currentChapterId: String
    ...
    override fun writeToParcel(dest: Parcel, flags: Int) {
        ...
        dest?.writeString(currentChapterId)
    }
